  ...
  return (
    <section className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
      ...
      <button
        ...
        className="mt-3 w-full py-2.5 text-sm font-bold rounded-xl bg-emerald-500 text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed hover:bg-emerald-600"
      >
