...
// v3 (Stage 18: "다른 금융소득" 입력을 스코프에서 제거하면서 otherFinancialIncomeKrw 필드도
// 삭제). 실사용 원문은 PROMPTS.md에도 동일하게 기록되어 있다 (지원서 제출용, 수정 시 함께
// 갱신할 것). v1/v2 원문은 PROMPTS.md에 그대로 남겨둔다.
